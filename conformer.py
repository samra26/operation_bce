...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.up21= nn.ConvTranspose2d(1, 1, kernel_size=3, stride=1, padding=1) 
        self.act=nn.Sigmoid()
        
        
        
    def forward(self, lde_out ):
        ...
        #print(self.up21(lde_out1).shape)
        ...
        return edge_rgbd0,edge_rgbd1,edge_rgbd2
...
class JL_DCF(nn.Module):
    ...
    def forward(self, f_all,f1_all):
        ...
        e_rgbd0,e_rgbd1,e_rgbd2=self.decoder(lde_out)

        return e_rgbd0,e_rgbd1,e_rgbd2
